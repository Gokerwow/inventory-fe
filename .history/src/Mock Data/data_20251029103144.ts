...
export type UserRoles = 'superAdmin' | 'adminGudangUmum' | 'timPPK' | 'timTeknis' | 'penanggungJawab' | 'instalasi';
...
export const MOCK_USERS: Record<UserRoles, MockUser> = {
    ...
    penanggungJawab: { // Typo? Mungkin 'penanggungJawab'
        user_id: 105,
        sso_user_id: 105,
...
export const riwayatPenerimaan = [
    {
        id: 1,
