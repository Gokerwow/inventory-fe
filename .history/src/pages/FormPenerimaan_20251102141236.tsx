                                        ...
                                        {barang.filter(item => item && item.nama_barang).map((item) => (
                                            ...
                                            >
                                                ...
                                                {user?.role === 'Tim Teknis' &&
                                                    <td className="flex justify-center items-center py-4 px-6 gap-3 text-white">
                                                        <div className="px-4 py-3 text-gray-700 text-center bg-green-500">
                                                            Layak
                                                        </div>
                                                        <div className="px-4 py-3 text-gray-700 text-center bg-red-500">
                                                            Tidak
                                                        </div>
                                                    </td>
                                                }
