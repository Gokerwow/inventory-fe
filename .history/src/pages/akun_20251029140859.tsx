    ...
    return (
        <div className="bg-slate-100 min-h-screen p-8">
            ...
            <div className="space-y-3">
                ...
                <div className="grid grid-cols-13 gap-4 items-center px-6 py-2">
                    <div className="col-span-1 text-sm font-medium text-gray-500 w-[30px]"></div>
                ...
                {MOCK_USERS.map((user, index) => (
                    <div
                        key={index}
                        className="grid grid-cols-[30px_1fr_2fr_2fr_3fr_2fr_2fr] gap-4 items-center bg-white rounded-xl shadow-sm py-3 px-6"
                    >
                        <div className={`col-span-1 h-full bg-[#EFF8FF] rounded-l-lg w-[30px]`}></div>
