...
export default function TambahAkunPage() {
    return (
        <div className="min-h-full bg-[#F3F7FA] rounded-lg  overflow-auto shadow-md flex flex-col">
            ...
            <div className="flex flex-col items-center bg-amber-500 flex-1">
                <div className="py-10">
                    <div className="bg-gray-600 rounded-full w-[279px] h-[279px]">
                    </div>
                </div>
                <div className="grid grid-cols-2 bg-amber-950 flex-1 w-full">
                    <div className="bg-amber-100 p-8 flex flex-col gap-4">
                        <Input 
                        id="role"
                        judul="role"
                        />
                    ...
                    <div className="bg-amber-800 p-8 flex flex-col gap-4">
                        <Input />
                        <Input />
                    </div>
                </div>
