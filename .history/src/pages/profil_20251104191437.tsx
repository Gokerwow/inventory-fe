                ...
                <div className="w-full">
                    <div className="flex flex-col gap-4 w-full">
                        {FAQ.map((faq, index) => (
                            <div
                                key={index}
                                className="w-full h-15 bg-white rounded-xl shadow-sm overflow-hidden transition-all duration-300"
                            >
                                <div 
                                    className='flex gap-4 h-full items-center cursor-pointer hover:bg-gray-50 transition-colors'
                                    onClick={() => toggleFAQ(index)}
                                >
                                    <div className="w-[30px] h-full bg-[#EFF8FF] rounded-l py-4"></div>
