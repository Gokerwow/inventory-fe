                    ...
                    <div className=" flex flex-col gap-2 p-4 bg-white rounded-2xl shadow">
                        ...
                        <div className='flex flex-col'>
                            ...
                            <select
                                ...
                                className="border-2 border-[#CDCDCD] p-2 pr-8 rounded-xl text-[#6E7781] appearance-none bg-[url('data:image/svg+xml;utf8,<svg fill=%22%236E7781%22 height=%2220%22 viewBox=%220 0 24 24%22 width=%2220%22 xmlns=%22http://www.w3.org/2000/svg%22><path d=%22M7 10l5 5 5-5z%22/></svg>')] bg-no-repeat bg-[right_0.75rem_center]"
                            >
