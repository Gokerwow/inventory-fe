    ...
    return (
        <div className="bg-white p-8 rounded-xl">
            ...
            <div className='border-t-3 border-[#CADCF2] py-4 flex flex-col gap-8'>
                ...
                {/* BUAT DAFTAR BELANJA */}
                <div className='shadow-[0_0_10px_rgba(0,0,0,0.1)] p-6 rounded-xl flex flex-col gap-4 items-center'>
                    <ShopCartIcon />
                    <span className='text-[#057CFF] font-bold text-xl'>Buat Daftar Belanja</span>
                </div>
            </div>
        </div>
    )
