...
export default function MonitoringPage() {
    ...
    const handleEditClick = (userData) => {
        navigate(PATHS.PROFIL.EDIT, {
            state: {
                isEdit: true,
                userData: userData, // atau data lain yang ingin dikirim
                // contoh:
                // id: user.id,
                // name: user.name,
                // email: user.email
                ...
                {currentItems.map((user, index) => (
                    ...
                    >
                        ...
                        <div className="col-span-2 flex justify-center py-3">
                            <button onClick={handleEditClick(userData)} className="flex items-center space-x-1 text-gray-600 hover:text-blue-800 cursor-pointer hover:scale-110 active:scale-95 transition-all duration-200">
                                <PencilIcon />
                                <span>Edit</span>
                            </button>
                        </div>
