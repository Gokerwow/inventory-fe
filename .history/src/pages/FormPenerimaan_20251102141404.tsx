                                            ...
                                            >
                                                ...
                                                {user?.role === 'Tim Teknis' &&
                                                    <td className="flex justify-center items-center py-4 px-6 gap-3 text-white font-semibold">
                                                        <div className="px-4 py-3 text-center bg-green-500 cursor-pointer hover:scale-110 active:scale-95 transition-all duration-200">
                                                            Layak
                                                        </div>
                                                        <div className="px-4 py-3 text-center bg-red-500 cursor-pointer hover:scale-110 active:scale-95 transition-all duration-200">
                                                            Tidak
                                                        </div>
                                                    </td>
                                                }
