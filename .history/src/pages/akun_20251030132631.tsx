...
export default function MonitoringPage() {
    ...
    const handleAddClick = () => {
        navigate('/akun/tambah-akun'); // Ganti dengan path yang sesuai
    };
    ...
    return (
        <div className="min-h-full p-8 bg-[#F3F7FA] rounded-lg shadow-md flex flex-col">
            ...
            <div className='place-self-end py-4 '>
                <PlusAkun onClick={handleAddClick} className='hover:scale-110 active:scale-95 transition-all duration-200 cursor-pointer' />
            </div>
