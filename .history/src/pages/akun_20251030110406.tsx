    ...
    return (
        <div className="min-h-full p-8 bg-[#F3F7FA] rounded-lg shadow-md">
            ...
            <div className="space-y-3">
                <div className="grid grid-cols-[30px_repeat(13,minmax(0,1fr))] gap-4 items-center py-2">
                    ...
                    <div className="col-span-2 text-sm font-medium text-gray-500 bg-amber-400">Role</div>
                    <div className="col-span-2 text-sm font-medium text-gray-500 bg-amber-800">Username</div>
                    <div className="col-span-3 text-sm font-medium text-gray-500">Waktu</div>
