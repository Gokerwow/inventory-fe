        ...
        <div className="bg-white shadow-[0_0_10px_rgba(0,0,0,0.1)] rounded-xl flex flex-col gap-4 w-full pb-15">
            ...
            <div className='px-15 w-full'>
                ...
                <div className="w-full">
                    {/* HEADER */}
                    <div className="flex items-center gap-4 px-6 py-3 text-xs font-medium text-gray-500 uppercase tracking-wider bg-amber-500">
                        <div className="w-[30px]"></div>
                        <div className="w-[80px] text-center">Foto Akun</div>
                        <div className="w-[200px] bg-amber-500">Daftar pegawai</div>
                        <div className="w-[150px] bg-amber-400">Jabatan</div>
                        <div className="w-[150px]">No telepon</div>
                        <div className="flex-1 text-center">Aktivitas</div>
                    </div>
                    ...
                    <div className="space-y-3">
                        {employees.map((employee) => (
                            <div
                                key={employee.id}
                                className="flex items-center gap-4 bg-white rounded-xl shadow-sm px-6 py-4"
                            >
                                {/* Strip biru */}
                                <div className="w-2 h-12 bg-[#EFF8FF] rounded-l"></div>

                                {/* Foto */}
                                <div className="w-[80px] flex justify-center bg-amber-500">
                                    <img
                                ...
                                {/* Nama */}
                                <div className="w-[200px] font-medium text-gray-900 bg-amber-500 truncate">{employee.name}</div>

                                {/* Jabatan */}
                                <div className="w-[150px] text-gray-700 bg-amber-700 truncate">{employee.job}</div>

                                {/* Telepon */}
                                <div className="w-[150px] text-gray-700">{employee.phone}</div>
