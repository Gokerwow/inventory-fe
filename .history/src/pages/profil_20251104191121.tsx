    ...
    return (
        <div className="bg-white shadow-[0_0_10px_rgba(0,0,0,0.1)] rounded-xl flex flex-col gap-4 w-full pb-15">
            ...
            <div className='px-15 w-full'>
                ...
                <div className="w-full">
                    <div className="flex flex-col gap-4 w-ful h-fulll">
                        {FAQ.map((FAQ) => (
                            <div
                                key={FAQ.question}
                                className="flex w-full h-full gap-4 items-center bg-white rounded-xl shadow-sm"
                            >
                                <div className="w-[30px] h-full bg-[#EFF8FF] rounded-l px-6 py-4"></div>
