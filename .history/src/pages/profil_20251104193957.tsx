                        ...
                        {employees.map((employee) => (
                            ...
                            >
                                ...
                                <div className="flex items-center justify-end gap-3 py-4 px-4">
                                    ...
                                    <PencilIcon onClick={} className="text-gray-400 cursor-pointer hover:scale-110 active:scale-95 transition-all duration-200"/>
                                </div>
                            </div>
                        ))}
                    </div>
                        ...
                        {FAQ.map((faq, index) => (
                            ...
                            >
                                ...
                                >
                                    ...
                                    <div className="flex-1 p-4 border-t-2 border-gray-300">
