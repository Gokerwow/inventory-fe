                        ...
                        <table className="min-w-full text-left">
                            ...
                            <thead>
                                <tr className="border-b border-gray-200">
                                    <th className="py-3 px-4 text-sm font-semibold text-gray-500 uppercase tracking-wider">
                                        Nama Barang
                                    </th>
                                    <th className="py-3 px-4 text-sm font-semibold text-gray-500 uppercase tracking-wider ">
                                        Kategori
                                    </th>
                                    <th className="py-3 px-4 text-sm font-semibold text-gray-500 uppercase tracking-wider text-center">
                                        Satuan
                                    </th>
                                    <th className="py-3 px-4 text-sm font-semibold text-gray-500 uppercase tracking-wider text-center">
                                        Jumlah
                            ...
                            <tbody>
                                {shoppingData.map((item) => (
                                    ...
                                    >
                                        <td className="py-4 px-4 text-gray-700 font-medium text-center">
                                            {item.nama}
                                        </td>
