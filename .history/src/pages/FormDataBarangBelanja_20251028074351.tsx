        ...
        <div className="h-full">
            ...
            <Modal isOpen={ isModalOpen } onClose={ handleCloseModal }>
                ...
                <div className="flex gap-4 justify-end">
                    <button onClick={handleCloseModal} className="text-white bg-green-600 py-2 w-25 rounded-lg hover:scale-110 active:scale-95 transition-all duration-200">
                        Iya
                    </button>
                    <button onClick={handleCloseModal} className="text-white bg-red-600 py-2 w-25 rounded-lg hover:scale-110 active:scale-95 transition-all duration-200">
                        Tidak
                    </button>
                </div>
            </Modal>
