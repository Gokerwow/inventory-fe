    ...
    return (
        <div className="min-h-full p-8 bg-white rounded-lg shadow-md">
            <div className="relative mb-8">
                ...
                <button aria-label='Menu' className="absolute top-0 right-0 p-3 bg-white rounded-lg shadow-md hover:bg-gray-100 transition-colors">
                ...
                {MOCK_USERS.map((user, index) => (
                    ...
                    >
                        ...
                        <div className="col-span-2 flex justify-center py-3">
                            <button className="flex items-center space-x-1 text-gray-600 hover:text-blue-800 hover:scale-110 active:scale-95 transition-all duration-200">
                                <PencilIcon />
                                <span>Edit</span>
                            </button>
                        </div>
