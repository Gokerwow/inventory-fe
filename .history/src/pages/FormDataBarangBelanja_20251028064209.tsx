        ...
        <div className="h-full">
            ...
            <Modal isOpen={ isModalOpen } onClose={ handleCloseModal }>
                ...
                <div className="flex gap-4 justify-end">
                    <button onClick={handleCloseModal} className="text-white bg-green-600 px-8 py-2 rounded-lg">
                        Cancel
                    </button>
                    <button onClick={handleCloseModal} className="text-white bg-red-600 px-4 py-2 rounded-lg">
                        Tidak
                    </button>
                </div>
            </Modal>
