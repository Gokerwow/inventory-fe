        ...
        <div className="bg-white shadow-[0_0_10px_rgba(0,0,0,0.1)] rounded-xl flex flex-col gap-4 w-full pb-15">
            ...
            <div className='px-15 w-full'>
                ...
                <div className="w-full">
                    ...
                    <div className="grid grid-cols-[30px_1fr_1fr_1fr_1fr_auto] gap-4 px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider items-center">
                        <span></span>
                        <span>Foto Akun</span>
                    ...
                    <div className="space-y-3">
                        {employees.map((employee) => (
                            <div
                                key={employee.id}
                                className="grid grid-cols-[30px_1fr_1fr_1fr_1fr_auto] gap-4 items-center bg-white rounded-xl shadow-sm px-6 py-4"
                            >
                                {/* Strip biru */}
