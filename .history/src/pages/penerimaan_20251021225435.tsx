    ...
    return (
        <div className="flex flex-col h-full p-6 bg-white rounded-lg shadow-md gap-4">
            ...
            <div className="flex flex-shrink-0 gap-4">
                <h1 onClick={() => handleClick(true)} className={`text-xl font-semibold text-gray-800 border-b-2 border-gray-400 py-2 ${isActive ? 'text-blue-400' : 'text-gray-800'}`}>Penerimaan</h1>
                <h1 onClick={() => handleClick(true)} className={`text-xl font-semibold text-gray-800 border-b-2 border-gray-400 py-2 ${isActive ? 'text-blue-400' : 'text-gray-800'}`}>Riwayat Penerimaan</h1>
            </div>
