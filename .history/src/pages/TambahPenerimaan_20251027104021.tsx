    ...
    return (
        <div className="bg-white p-8 rounded-xl">
            ...
            <div className='border-t-3 border-[#CADCF2] py-4 flex flex-col gap-8'>
                ...
                {/* BUAT DAFTAR BELANJA */}
                <div className='shadow-[0_0_10px_rgba(0,0,0,0.1)] py-20 rounded-xl flex flex-col gap-4 items-center cursor-pointer select-none transition-all duration-200'>
                ...
                {/* BUTTON SELESAI */}
                <button className='bg-[#00b998] px-10 py-2 rounded-md text-white self-end font-bold text-lg cursor-pointer active:scale-95 hover:bg-[#02ad8d] transition-all duration-200'>
                    Selesai
                </button>
            </div>
        </div>
