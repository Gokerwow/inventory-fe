                    ...
                    <div className="flex flex-col gap-6 p-6 bg-white rounded-2xl shadow-[0_0_10px_rgba(0,0,0,0.1)]">
                        ...
                        <div className="relative flex flex-col">
                            ...
                            <button
                                ...
                                className="text-[#6E7781]/20 hover:bg-gray-300/50 transition-all duration-200 rounded-lg border-2 border-[#CDCDCD] text-sm px-5 py-2.5 inline-flex items-center justify-between"
                            >
                                Masukkan Nama
