    ...
    return (
        <div className="bg-white rounded-lg shadow-md p-4">
            <ul className="flex gap-2 justify-center items-center text-lg font-bold ">
                <li className="py-2 border-b-4">Penerimaan</li>
                <li className="py-2 border-b-4 border-gray-400 text-gray-500">Riwayat Penerimaan</li>
            </ul>
            <table className="w-full text-sm text-gray-700 bg-amber-500">
