        ...
        if (startPage > 1) {
            buttons.push(
                <button
                    ...
                    className={`px-3 py-2 rounded-md text-sm ${1 === currentPage
        ...
        for (let i = startPage; i <= endPage; i++) {
            buttons.push(
                <button
                    ...
                    className={`px-3 py-2 rounded-md text-sm ${currentPage === i
                        ? 'bg-blue-600 text-white'
                        : 'bg-white text-gray-700 hover:bg-gray-100 border border-gray-300'
                        }`}
                >
        ...
        if (endPage < totalPages) {
            ...
            buttons.push(
                <button
                    ...
                    className={`px-3 py-2 rounded-md text-sm ${totalPages === currentPage
                        ? 'bg-blue-600 text-white'
                        : 'bg-white text-gray-700 hover:bg-gray-100 border border-gray-300'
                        }`}
                >
                    ...
                    <tbody className="bg-white divide-y divide-gray-200">
                        {currentItems.map((item, index) => (
                            <tr
                                ...
                                className="hover:bg-gray-50 transition-colors duration-150 shadow-2xl"
                            >
                                ...
                                <td className='px-4 py-4 whitespace-nowrap text-sm flex items-center gap-1 cursor-pointer hover:text-blue-600 hover:translate-y-1 transition-all duration-200 '>
                                    <UnduhIcon />
                                    <span>Unduh</span>
                                </td>
                                <td className="px-4 py-4 whitespace-nowrap text-sm">
