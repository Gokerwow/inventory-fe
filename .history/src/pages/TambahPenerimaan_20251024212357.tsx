    ...
    return (
        <div className="min-h-screen bg-gray-50 py-8 px-4 rounded-lg">
                ...
                <div className="py-6 px-8">
                    <h1 className="text-2xl font-bold text-center text-blue-500 ">FORM DATA BARANG BELANJA</h1>
                    <p className="text-center mt-2">Dokumen Resmi RSUD BALUNG</p>
                </div>

                <form onSubmit={handleSubmit} className="p-8 space-y-8 flex">
                    {/* Pihak Pertama */}
