                    ...
                    <tbody className="bg-white divide-y divide-gray-200">
                        {currentItems.map((item, index) => (
                            ...
                            >
                                ...
                                <td className='px-4 py-4 whitespace-nowrap text-sm flex items-center gap-1 cursor-pointer hover:text-blue-600 hover:translate-y-1 transition-all duration-500 ease-out bounce'>
                                    <UnduhIcon />
                                    <span>Unduh</span>
                                </td>
                                <td className="px-4 py-4 whitespace-nowrap text-sm">
