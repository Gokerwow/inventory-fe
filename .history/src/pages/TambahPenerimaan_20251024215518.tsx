                    ...
                    <div className=" flex flex-col gap-2 p-4 bg-white rounded-2xl shadow">
                        ...
                        <div className="flex flex-col">
                            ...
                            <select
                                ...
                                className="border-2 bg-amber-300 border-[#CDCDCD] p-2 pr-8 rounded-xl text-[#6E7781] appearance-none w-full relative"
                            >
                                ...
                                <svg
                                    className="absolute bg-amber-500 pointer-events-none text-[#6E7781]"
