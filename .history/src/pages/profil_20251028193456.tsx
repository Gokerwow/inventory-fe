                ...
                <div className="w-full">
                    <div className="grid grid-cols-[30px_80px_1fr_1fr_1fr_auto] gap-x-4 gap-y-3">
                        ...
                        {employees.map((employee) => (
                            ...
                            >
                                <div className="w-2 h-full bg-[#EFF8FF] rounded-l px-6 py-4"></div>

                                <div className="flex justify-center bg-amber-500 py-4">
                                    <img
                                ...
                                <div className="font-medium text-gray-900 bg-amber-500 px-6 py-4">{employee.name}</div>
