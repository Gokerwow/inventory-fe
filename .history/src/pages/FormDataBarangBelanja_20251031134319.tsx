...
const FormDataBarangBelanja = (barang) => {
    ...
    const handleSubmit = (e) => {
        ...
        navigate(PATHS.PENERIMAAN.TAMBAH,     state: {
        formData: formData  // atau data apapun yang ingin dikirim
    })
    ...
    return (
        <div className="h-full">
            <div className="bg-white shadow-[0_0_10px_rgba(0,0,0,0.1)] p-6 h-full rounded-xl flex flex-col gap-4">
                ...
                <form onSubmit={handleSubmit} className="border-t-2 border-[#CADCF2] grid grid-cols-2 p-8 gap-8" onSubmit={handleSubmit}>
