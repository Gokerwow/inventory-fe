...
export default function MonitoringPage() {
    ...
    return (
        <div className="min-h-full p-8 bg-[#F3F7FA] rounded-lg shadow-md">
            <div className="relative mb-8 bg-amber-500" ref={dropdownRef}>
                ...
                {/* Dropdown Menu */}
                {isOpen && (
                    <div className="absolute top-0 right-0 z-50 w-56 mt-2 origin-top-right bg-white rounded-lg shadow-lg ">
                        {/* Header */}
