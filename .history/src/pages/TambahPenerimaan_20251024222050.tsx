                    ...
                    <div className=" flex flex-col gap-2 p-4 bg-white rounded-2xl shadow">
                        ...
                        <div className="relative flex flex-col">
                            ...
                            <button
                                ...
                                className="text-[#6E7781] hover:bg-gray-300/50 transition-all rounded-lg border-2 border-[#CDCDCD] text-sm px-5 py-2.5 inline-flex items-center justify-between"
                            >
                                Dropdown button
