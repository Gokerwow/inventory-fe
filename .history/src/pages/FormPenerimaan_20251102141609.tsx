                    ...
                    {!barang || barang.length === 0 ?
                        ...
                        <>
                            <div className="flex justify-between items-center border-b border-gray-200 p-6">
                                ...
                                <button onClick={handleAddClick} className="bg-green-500 hover:bg-green-600 cursor-pointer hover:scale-110 active:scale-95 transition-all duration-200 rounded-lg text-white font-medium py-2 px-5 shadow-sm">
                                    Tambah Barang
                                </button>
                            </div>
