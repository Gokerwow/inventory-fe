...
export default function TambahAkunPage({ isEdit }: { isEdit?: boolean }) {
    ...
    return (
        <div className="min-h-full bg-[#F3F7FA]  shadow-md flex flex-col">
            <h1 className="bg-[#057CFF] p-8 text-2xl rounded-t-lg text-white text-center font-semibold shadow-lg">{isEdit ? 'TAMBAH AKUN BARU' : 'EDIT PROFIL'}</h1>
...
{isEdit ? (
  <div className="bg-gray-600 rounded-full w-[279px] h-[279px] shadow-lg">
    {user?.avatarUrl ? (
      <img
        ...
        onError={(e) => {
          console.error('Gambar gagal dimuat:', user.avatarUrl);
  ...
  <div className="bg-gray-600 rounded-full w-[279px] h-[279px] shadow-lg"></div>
)}
