export default function Penerimaan() {
    ...
    return (
        <div className="bg-white rounded-lg shadow-md p-4">
            <ul className="flex gap-2 justify-center items-center text-lg font-bold bg-amber-900">
                <li className="bg-blue-300 p-4">Penerimaan</li>
                <li className="bg-blue-300 p-4">Penerimaan</li>
                <li className="bg-blue-300 p-4">Riwayat Penerimaan</li>
            </ul>
