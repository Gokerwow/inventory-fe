                ...
                <div className='shadow-[0_0_10px_rgba(0,0,0,0.1)] p-6 rounded-xl flex flex-col gap-4'>
                    ...
                    <div className="relative flex flex-col">
                        ...
                        <div className="relative w-full">
                            <label
                                htmlFor="namaPihakPertama"
                                className="absolute left-5 top-1/2  text-gray-400 pointer-events-none"
                            >
                            ...
                            <input
                                id="namaPihakPertama"
                                type="text"
                                className="text-[#6E7781] border-2 border-[#CDCDCD] rounded-lg text-sm px-5 py-2.5 w-full focus:outline-none focus:border-blue-500 h-50"
                            />
                        </div>
                    </div>
                </div>
