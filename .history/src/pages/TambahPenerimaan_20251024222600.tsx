...
<div className="relative flex flex-col">
  <div className="relative">
    <input
      type="text"
      id="namaPihakPertama"
      className="peer text-[#6E7781] border-2 border-[#CDCDCD] rounded-lg text-sm px-5 pt-5 pb-2.5 w-full focus:outline-none focus:border-blue-500 placeholder-transparent"
      placeholder="Nama Lengkap"
    />
    <label
      htmlFor="namaPihakPertama"
      className="absolute left-5 top-2.5 text-gray-500 text-sm transition-all duration-200 peer-placeholder-shown:top-3.5 peer-placeholder-shown:text-gray-400 peer-placeholder-shown:text-sm peer-focus:top-1 peer-focus:text-xs peer-focus:text-blue-500"
    >
      Nama Lengkap
    </label>
  </div>

  <label htmlFor="jabatanPihakPertama" className="mt-2">
    Masukkan jabatan
  </label>
</div>
