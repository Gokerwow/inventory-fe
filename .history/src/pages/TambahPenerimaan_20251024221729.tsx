            ...
            <div className=''>
                <div className=' py-4 grid grid-cols-2 gap-8'>
                    <div className=" flex flex-col gap-2 p-4 bg-white rounded-2xl shadow">
                        ...
                        <div className="relative flex flex-col w-full bg-amber-800">
                            <label className="mb-2 font-semibold">Nama Lengkap</label>
                            <button
                                onClick={() => setOpen(!open)}
                                className="text-white bg-blue-700 hover:bg-blue-800 rounded-lg text-sm px-5 py-2.5 inline-flex items-center"
                            >
                                Dropdown button
                            ...
                            {open && (
                                <div className="absolute top-full mt-2 z-10 bg-white divide-y divide-gray-100 rounded-lg shadow-sm w-44">
