...
const LihatPenerimaan = () => {
    ...
    return (
        <div className="min-h-full mx-auto p-8 bg-white rounded-lg">
            ...
            <div className="border-2 border-dashed border-gray-300 rounded-lg p-8 flex flex-col items-center gap-4 mb-8">
            ...
            {/* Footer */}
            <div className="mt-8 pt-4 border-t border-gray-200 flex">
                <ButtonConfirm 
                text='Unggah BAST'
                className='w-50 place-self-end'
                />
            </div>
        </div>
    );
