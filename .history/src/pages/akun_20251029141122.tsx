    ...
    return (
        <div className="bg-slate-100 min-h-screen p-8">
            ...
            <div className="space-y-3">
                ...
                <div className="grid grid-cols-[30px_repeat(12,minmax(0,1fr))] gap-4 items-center px-6 py-2">
                ...
                {MOCK_USERS.map((user, index) => (
                    <div
                        key={index}
                        className="grid grid-cols-[30px_repeat(12,minmax(0,1fr))] gap-4 items-center bg-white rounded-xl shadow-sm"
                    >
                        <div className={`col-span-1 h-full bg-[#EFF8FF] rounded-l-lg`}></div>
                        
                        {/* Foto Akun */}
                        <div className="col-span-1  py-3 px-6">
                            <img
                                src={user.avatarUrl}
                                alt="Avatar"
