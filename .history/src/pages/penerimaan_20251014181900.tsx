...
export default function Penerimaan() {
    ...
    return (
        <div className="bg-[#F3F7FA]  relative z-10 rounded-lg overflow-hidden">
                ...
                <div className="px-6">
                    <div className="flex gap-8 justify-center items-center">
                        <button
                            ...
                            className={`py-4 font-medium border-b-4 transition-colors font-bold ${activeTab === 'penerimaan'
                        ...
                        <button
                            ...
                            className={`py-4 font-medium border-b-4 transition-colors ${activeTab === 'riwayat'
                                    ? 'border-blue-900 text-[#152F54]'
                                    : 'border-[#9C9C9C] text-gray-500 hover:text-gray-700'
                                }`}
                        >
            ...
            {/* Table */}
            <div className="pt-6 bg-amber-500">
