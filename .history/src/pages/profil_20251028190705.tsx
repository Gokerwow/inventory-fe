        ...
        <div className="bg-white shadow-[0_0_10px_rgba(0,0,0,0.1)] rounded-xl flex flex-col gap-4 w-full pb-15">
            ...
            <div className='px-15 w-full'>
                ...
                <div className="w-full">
                    <div className="grid grid-cols-[5px_80px_2fr_2fr_2fr_1fr_auto] gap-4 px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">
                        <span></span>
                        <span>Foto Akun</span>
                    ...
                    <div className="space-y-3">
                        {employees.map((employee) => (
                            <div
                                key={employee.id}
                                className="grid grid-cols-[25px_80px_2fr_2fr_2fr_1fr_auto] gap-4 items-center bg-white p-4 rounded-xl shadow-sm"
                            >
                                <div className='w-full bg-amber-500 h-50'>
                                ...
                                <div>
                                    <span className="w-25 py-2 inline-flex text-xs leading-5 font-semibold rounded-full bg-[#00B998] text-white justify-center">
                                        {employee.status}
                                    </span>
                                </div>
