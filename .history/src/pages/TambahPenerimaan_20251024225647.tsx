        ...
        <div className="bg-white p-8 rounded-xl">
            ...
            <div className='border-t-3 border-[#CADCF2] py-4 flex flex-col gap-8'>
                    ...
                    <div className="flex flex-col gap-6 p-6 bg-white rounded-2xl shadow-[0_0_10px_rgba(0,0,0,0.1)]">
                        ...
                        <div className="relative flex flex-col">
                            ...
                            <button
                                ...
                                className="text-[#6E7781]/30 hover:bg-gray-300/50 transition-all duration-200 rounded-lg border-2 border-[#CDCDCD] text-sm px-5 py-2.5 inline-flex items-center justify-between"
                            >
                                Masukkan Nama
                ...
                <div className=' shadow-[0_0_10px_rgba(0,0,0,0.1)] p-6 rounded-xl flex flex-col gap-4'>
                    ...
                    {/*ALAMAT SATKER */}
                    <div className="relative flex flex-col">
                        <label className="mb-2 font-semibold">Nomor Surat</label>
                ...
                <div className='shadow-[0_0_10px_rgba(0,0,0,0.1)] p-6 rounded-xl flex flex-col gap-4'>
                    ...
                    {/*ALAMAT SATKER */}
                    <div className="relative flex flex-col">
                        <label className="mb-2 font-semibold">Deskripsi Barang</label>

                        <div className="relative w-full">
                            <label
                                htmlFor="namaPihakPertama"
                                className="absolute left-5 top-2 text-gray-400 pointer-events-none transition-all duration-200 peer-focus:hidden peer-[&:not(:placeholder-shown)]:hidden"
                            >
