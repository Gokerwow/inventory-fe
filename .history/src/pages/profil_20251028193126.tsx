        ...
        <div className="bg-white shadow-[0_0_10px_rgba(0,0,0,0.1)] rounded-xl flex flex-col gap-4 w-full pb-15">
            ...
            <div className='px-15 w-full'>
                ...
                <div className="w-full">
                    ...
                    <div className="grid grid-cols-[30px_80px_1fr_1fr_1fr_auto] gap-4 px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider items-center bg-amber-700">
                        <span></span>
                        <span>Foto Akun</span>
                    ...
                    <div className="space-y-3">
                        {employees.map((employee) => (
                            <div
                                key={employee.id}
                                className="grid grid-cols-[30px_80px_1fr_1fr_1fr_auto] gap-4 items-center bg-white rounded-xl shadow-sm"
                            >
                                {/* Strip biru */}
                                <div className="w-[30px] h-full bg-[#EFF8FF] rounded-l"></div>
                                
                                {/* Foto */}
                                <div className="flex justify-center bg-amber-500 p-4">
                                    <img
                                ...
                                {/* Nama */}
                                <div className="font-medium text-gray-900 bg-amber-500 p-4">{employee.name}</div>

                                {/* Jabatan */}
                                <div className="text-gray-700 bg-amber-700 p-4">{employee.job}</div>

                                {/* Telepon */}
                                <div className="text-gray-700 p-4">{employee.phone}</div>

                                {/* Status & Aksi */}
                                <div className="flex items-center justify-end gap-3p-4">
