...
const PenerimaanTable = () => {
    ...
    const itemsPerPage = 7; // Dibatasi 7 data per halaman
    ...
    return (
        <div className="p-6 bg-white rounded-lg shadow-md h-full">
            ...
            {/* Pagination */}
            <div className="flex flex-col sm:flex-row items-center justify-between gap-4 border-t border-gray-200 pt-4 self-end">
