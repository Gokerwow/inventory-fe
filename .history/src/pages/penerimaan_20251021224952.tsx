...
const PenerimaanTable = () => {
    ...
    const handleActivatePage = (isActive) => {
    ...
    return (
        <div className="flex flex-col h-full p-6 bg-white rounded-lg shadow-md gap-4">
            ...
            <div className="flex flex-shrink-0 gap-4">
                <h1 onClick={handleActivatePage} className={`text-xl font-semibold text-gray-800 border-b-2 border-gray-400 py-2 ${isActive}`}>Penerimaan</h1>
                <h2 className="text-xl font-semibold text-gray-700 border-b-2 border-gray-400 py-2">Riwayat Penerimaan</h2>
            </div>
