...
const PenerimaanTable = () => {
    ...
    return (
        <div className="flex flex-col h-full p-6 bg-white rounded-lg shadow-md">
            {/* Header */}
            <div className="flex flex-shrink-0 bg-amber-700">
                <h1 className="text-xl font-semibold text-gray-800 mb-2 border-b-2 border-gray-400">Penerimaan</h1>
                <h2 className="text-xl font-semibold text-gray-700 mb-6">Riwayat Penerimaan</h2>
            </div>
