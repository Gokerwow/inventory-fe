...
const PenerimaanTable = () => {
    ...
    useEffect(() => {
        const calculateItemsPerPage = () => {
            const tableHeaderHeight = 120; // Approximate height of header and table header
            const rowHeight = 60; // Approximate height per row
            const availableHeight = window.innerHeight - tableHeaderHeight - 100; // Subtract margins/padding
