        ...
        <div className="h-full">
            ...
            <Modal isOpen={ isModalOpen } onClose={ handleCloseModal }>
                ...
                <div className="flex gap-4 justify-end">
                    <NavLink to='/penerimaan/tambah'>
                        <button onClick={handleCloseModal} className="text-white bg-green-600 py-2 w-25 rounded-lg hover:scale-110 active:scale-95 transition-all duration-200 cursor-pointer">
                            Iya
                        </button>
                    </NavLink>
                    <button onClick={handleCloseModal} className="text-white bg-red-600 py-2 w-25 rounded-lg hover:scale-110 active:scale-95 transition-all duration-200 cursor-pointer">
                        Tidak
                    </button>
                </div>
            </Modal>
