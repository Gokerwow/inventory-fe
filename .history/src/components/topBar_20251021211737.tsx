...
export default function TopBar() {
    return (
        <div className="w-full flex items-center justify-between bg-amber-600 shadow-lg z-50 py-4.5">
            <div className='overflow-hidden flex h-20 items-stretch flex-1 justify-between'>
                ...
                <NavLink to={'/profil'}>
                    <div className='flex items-center justify-center bg-amber-200 gap-4 px-4 bg-gray-40 h-full cursor-pointer hover:bg-gray-200 transition-colors duration-200'>
