                    ...
                    {menuItems.map((item) => (
                        <li key={item.path}>
                            <NavLink
                                to={item.path}
                                className={({ isActive }) =>
                                    `flex items-center gap-4 p-2 rounded-md cursor-pointer transition-all duration-300 bg-white/30 ${isActive
                                        ? 'bg-blue-500 text-white'
                                        : ' text-white hover:bg-blue-500 hover:text-white group'
                                    }`
                                }
                            >
                                {({ isActive }) => (
