...
export default function SideBar() {
    const menuItems = [
        ...
        { path: '/penerimaan', icon: PenerimaanIcon, label: 'Penerimaan', role: ['adminGudangumum', 'timPPK'] },
        { path: '/pengeluaran', icon: PengeluaranIcon, label: 'Pengeluaran', role: ['adminGudangumum'] },
