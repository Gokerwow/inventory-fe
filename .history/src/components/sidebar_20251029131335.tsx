...
export default function SideBar() {
    const menuItems = [
        { path: '/akun', icon: DashboardIcon, label: 'Dashboard', role: ['Super Admin'] },
        { path: '/pegawai', icon: DashboardIcon, label: 'Dashboard', role: ['Super Admin'] },
        { path: '/monitoring', icon: DashboardIcon, label: 'Dashboard', role: ['Super Admin'] },
        ...
        { path: '/penerimaan', icon: PenerimaanIcon, label: 'Penerimaan', role: ['Admin Gudang Umum', 'Tim PPK', 'Tim Tekni'] },
        { path: '/pengeluaran', icon: PengeluaranIcon, label: 'Pengeluaran', role: ['Penanggung Jawab', 'adminGudangUmum'] },
