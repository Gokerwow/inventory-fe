...
export default function SideBar() {
    ...
    return (
        <div className='w-[394px] fixed h-full'>
            <div className="bg-white text-white flex flex-col justify-between rounded-lg overflow-hidden shadow-md border-2 border-white">
                <ul className='flex flex-col gap-6 px-4 py-10 h-screen'>
                    {menuItems.map((item) => (
                        <li key={item.path}>
                            <NavLink
                                to={item.path}
