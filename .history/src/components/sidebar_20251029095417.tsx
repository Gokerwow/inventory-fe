...
export default function SideBar() {
    const menuItems = [
        { path: '/akun', icon: DashboardIcon, label: 'Dashboard', role: ['adminGudangumum'] },
        { path: '/pegawai', icon: DashboardIcon, label: 'Dashboard', role: ['adminGudangumum'] },
        { path: '/monitoring', icon: DashboardIcon, label: 'Dashboard', role: ['adminGudangumum'] },
        ...
        { path: '/pemesanan', icon: PengeluaranIcon, label: 'Pengeluaran' },
        { path: '/pengeluaran', icon: PengeluaranIcon, label: 'Pengeluaran' },
    ];
        ...
        <div className='w-[300px] h-full bg-[#057CFF]'>
            <div className="text-white flex flex-col h-full rounded-lg overflow-hidden shadow-md">
                ...
                <ul className='flex flex-col gap-6 px-4 py-10 '>
                    ...
                    <li>
                        <NavLink to='/'>
                            <div className='bg-red-800 p-2 flex justify-center items-center gap-2 rounded-lg hover:scale-105 active:scale-95 transition-all duration-200'>
                                <LogoutIcon />
                                <span>Logout</span>
                            </div>
                        </NavLink>
