...
export default function SideBar() {
    ...
    const menuItems = [
        ...
        { path: '/pencatatan-stok', icon: Package, label: 'Stok Barang' },
        { path: '/Penerimaan', icon: TrendingUp, label: 'Penerimaan' },
    ...
    return (
        <div className='w-[394px] p-4 flex-1'> {/* Parent harus h-screen */}
