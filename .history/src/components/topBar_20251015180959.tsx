...
export default function TopBar() {
    return (
        <div className="w-full flex items-center justify-between gap-6 rounded-b-4xl bg-white overflow-hidden">
            <div className='p-4'>
            ...
            <div>
                <div className='flex items-center justify-center gap-4 bg-red-500 px-4 py-6'>
