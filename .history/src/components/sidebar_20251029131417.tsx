...
export default function SideBar() {
    const menuItems = [
        { path: '/akun', icon: DashboardIcon, label: 'Akun', role: ['Super Admin'] },
        { path: '/pegawai', icon: DashboardIcon, label: 'Pegawai', role: ['Super Admin'] },
        { path: '/monitoring', icon: DashboardIcon, label: 'Monitoring', role: ['Super Admin'] },
