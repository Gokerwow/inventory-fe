...
export default function SideBar() {
    ...
    return (
        <div className='w-[394px] h-full'>
            <div className="bg-red-700 text-white flex flex-col h-full rounded-lg overflow-hidden shadow-md border-2 border-white">
                <div className='bg-amber-700 flex justify-center items-center'>
