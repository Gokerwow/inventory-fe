...
export default function SideBar() {
    const menuItems = [
        { path: '/dashboard', icon: '/assets/DashboardIcon.svg?react', label: 'Dashboard' },
        { path: '/pencatatan-stok', icon: '/assets/Chart.svg?react', label: 'Pencatatan Stok' },
        { path: '/penerimaan', icon: '/assets/Penerimaan.svg?react', label: 'Penerimaan' },
