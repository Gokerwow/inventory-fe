...
export default function SideBar() {
    const menuItems = [
        ...
        { path: '/penerimaan', icon: PenerimaanIcon, label: 'Penerimaan', role: ['Admin Gudang Umum', 'Tim PPK', 'timTeknis'] },
        { path: '/pengeluaran', icon: PengeluaranIcon, label: 'Pengeluaran', role: ['penanggungJawab', 'adminGudangUmum'] },
