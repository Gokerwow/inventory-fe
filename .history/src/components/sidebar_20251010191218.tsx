...
export default function SideBar() {
    return (
        <div className='w-[394px] p-4'> {/* Parent harus h-screen */}
            <div className="bg-[#CADCF2] text-white flex flex-col justify-between h-full rounded-lg overflow-hidden shadow-md">
