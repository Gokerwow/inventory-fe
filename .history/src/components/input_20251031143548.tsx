export default function Input({ id, judul, placeholder, value, type, name, onChange }: { id: string, judul: string, placeholder: string, value?: string, type?: string, name: string, onChange: () => void }) {
    return (
