                    ...
                    <tbody className="bg-white divide-y divide-gray-200">
                        {currentItems.map((item, index) => (
                            ...
                            >
                                ...
                                <td className='whitespace-nowrap text-sm cursor-pointer hover:text-blue-600 hover:translate-y-1 transition-all duration-200'>
                                    <NavLink to={`/penerimaan/unduh/${item.id}`}>
                                        <div className='flex items-center gap-1 bg-amber-500 px-4 py-4'>
                                            <EyeIcon />
                                            <span>Lihat</span>
                                        </div>
                                    </NavLink>
