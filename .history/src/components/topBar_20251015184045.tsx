    ...
    return (
        <div className="w-full flex items-center justify-between rounded-b-4xl bg-white">
            <div className='overflow-hidden rounded-b-4xl flex-1 flex items-center justify-between'>
                <div className='p-4 bg-amber-600 flex-1'>
                    <img src={SimbaLogo} alt="Simba Logo"/>
                </div>
                <div className='text-2xl font-bold bg-amber-400 flex-1'>
                    <p className='text-center'>Selamat Datang</p>
                    <p className='text-center text-[#4D5ED1]'>Admin Gudang Umum 👋🏻!</p>
                </div>
                <div className='flex items-center justify-center gap-4 px-4 py-6 bg-gray-400 flex-1'>
