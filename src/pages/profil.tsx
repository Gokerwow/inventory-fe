    ...
    return (
        <div className="w-full flex flex-col gap-5">
            ...
            <div className="bg-[#005DB9] flex items-center gap-4 rounded-xl p-10 text-white shadow-md relative">
                <div className='rounded-full border-4 border-white bg-white/10 w-32 h-32 md:w-40 md:h-40 flex items-center justify-center overflow-hidden shadow-2xl backdrop-blur-sm'>
